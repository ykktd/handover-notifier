...
<!-- TODO: ./docs/screenshot-home.png を追加 -->
**通知一覧画面（ホーム）** — 月ごとにグルーピングされた通知カード。各カードから「今すぐ送信／編集／削除」が可能。

<!-- TODO: ./docs/screenshot-edit.png を追加 -->
**通知 追加・編集フォーム** — メッセージを主役にしたシンプルな入力画面。文字数カウンター付き。

<!-- TODO: ./docs/screenshot-settings.png を追加 -->
**送信先の設定画面** — Slack Webhook URL と Gmail 送信先メールをここで一元管理。
...
<!-- TODO: ./docs/screenshot-step1-extensions.png を追加 -->
...
<!-- TODO: ./docs/screenshot-step3-initialize.png を追加 -->
...
<!-- TODO: ./docs/screenshot-step4-deploy.png を追加 -->
...
設計判断の詳細（なぜこの構成にしたか）は [handover-bot-spec.md](handover-bot-spec.md) を参照してください。
