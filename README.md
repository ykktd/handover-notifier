...
▶ セットアップ実演動画: [動画を見る](docs/handover-notifier-setup-demo.mp4)  
...
> テンプレートURLがまだ記載されていない場合は、前任者またはリポジトリ管理者に確認してください。リポジトリ管理者向けのテンプレート作成手順は後述の「[テンプレートの管理](#テンプレートの管理)」を参照してください。
